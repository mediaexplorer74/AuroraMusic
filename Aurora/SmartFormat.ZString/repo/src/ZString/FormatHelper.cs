...
namespace Cysharp.Text
{
    internal static partial class Utf16FormatHelper
    {
            ...
            where TBufferWriter : IBufferWriter<char>
        {
            ...
            {
                Span<char> s = stackalloc char[typeof(T) == typeof(ValueType) ? Unsafe.SizeOf<T>() * 8 : 1024];
    ...
    internal static partial class Utf8FormatHelper
    {
            ...
            where TBufferWriter : IBufferWriter<byte>
        {
            ...
            {
                Span<byte> s = stackalloc byte[typeof(T)== typeof(ValueType) ? Unsafe.SizeOf<T>() * 8 : 1024];
