...
public class StringSource : Source
{
    ...
    {
        selectorInfo.Result = currentValue.ToUpper();
        return true;
    }
    ...
    {
        selectorInfo.Result = currentValue.ToLower();
        return true;
    }
    ...
    private bool Capitalize(ISelectorInfo selectorInfo, string currentValue)
    {
        ...
        selectorInfo.Result = char.ToUpper(currentValue[0]) + currentValue.Substring(1);
        return true;
    }
