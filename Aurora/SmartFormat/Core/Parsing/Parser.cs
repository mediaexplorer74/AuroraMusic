...
public class Parser
{
    ...
    private void ParseHtmlTags()
    {
        ...
        if (_inputFormat.AsSpan(_index.Current).StartsWith(scriptTagName, StringComparison.CurrentCultureIgnoreCase))
        {
        ...
        if (_inputFormat.AsSpan(_index.Current).StartsWith(styleTagName, StringComparison.CurrentCultureIgnoreCase))
        {
        ...
        while (true)
        {
            ...
            if (_inputFormat[_index.Current] == '/' && _inputFormat[_index.Current + 1] == '>' && _inputFormat
                    ...
                    .StartsWith(currentTagName, StringComparison.CurrentCultureIgnoreCase))
            {
                _index.Current++;
                return;
            }
